...
<head>
    ...
    <title>ソフトウェア開発・機械設計・電気設計・エンジニア派遣・DTPデザインの京設工業株式会社−エントリーフォーム/システムエンジニア/技術者/人材派遣/転職/プラスチック容器</title>
    <?php include 'ref.php';?>
</head>
            ...
            <div id="contents">
                ...
                <div id="right">
                    <table width="510" border="0" cellspacing="10" cellpadding="0">
                        <tr>
                            <td><img src="./image/bn_rec_kojin.jpg" alt="個人情報の取り扱いについて" width="240" height="45"></td>
                        </tr>
                        <tr>
                            <td>応募の際は、下記規約を必ずご覧いただき、内容に同意する場合は［同意する］ボタンを押して次にお進みください。 同意しない場合は［同意しない］ボタンを押してください。</td>
                        </tr>
                    </table>
                    <div class="kiyaku1">
                        <table>
                ...
                <div id="leftmenu">
                    ...
                    <ul id="tatemenu">
                        ...
                        <li><a href="recruite_career.php" class="recuit_career">キャリア採用情報</a></li>
                        <li><a href="recruite_career.php#obo2" class="recuit_obo2">応募方法・選考の流れ（キャリア）</a></li>
