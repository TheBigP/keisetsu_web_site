        ...
        <div class="col-sm-12">
            <div id="left">
                <table class="table table-bordered" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <td class="under10"><img src="./image/bmida_honsya.jpg" alt="コンピュータ・ソフトウエア開発部門" width="100%">
                        </td>
                    </tr>
                    </thead>
                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right"><a
                                                        ...
                                                        target="map"><img src="./image/bt_googlemap.gif"
                                                                          alt="京設工業 本社 詳細地図はこちら" width="100%"
                                                                          border="0"></a></td>
                                        </tr>
                                        </tbody>
                                    </table>
                    ...
                    <tr>
                        <div>
                            <table class="table table-bordered" width="100%" border="0" cellpadding="5" cellspacing="1"
                                ...
                                <tr>
                                    <th bgcolor="#FFFFFF" style="font-size:15px"><img src="./image/p_2.gif" alt=""
                                                                                      width="9" height="10">TEL
                                    </th>
                                    <td bgcolor="#FFFFFF" style="font-size:15px">047－453－0675</td>
                                </tr>
                                <tr>
                                    <th bgcolor="#FFFFFF" style="font-size:15px"><img src="./image/p_2.gif" alt=""
                                                                                      width="9" height="10">FAX
                                    </th>
                                    <td bgcolor="#FFFFFF" style="font-size:15px">047－453－0670</td>
                                </tr>
                                <tr>
                                    <th bgcolor="#FFFFFF" style="font-size:15px"><img src="./image/p_2.gif" alt=""
                                                                                      width="9" height="10">業務内容
                                    </th>
                                    <td bgcolor="#FFFFFF" style="font-size:15px" class="under10"><p>
                    ...
                    <div style="overflow:auto">
                        <img src="./image/map_honsya.gif" alt="京設工業株式会社本社・茜浜事業所周辺地図" width="" height="">
                    </div>
                    </tr>
                    </tbody>
                </table>
