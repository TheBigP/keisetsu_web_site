    ...
    <div class="container">
            ...
            <div class="col-sm-4 d-none d-sm-block">
                <div id="left">
                    ...
                    <div style="text-align: left;margin-left: 2%;box-shadow: 0 0 3px 0px #9588bc;">
                        ...
                        <h3 id="under10kasen_id">〒275-0024　千葉県習志野市茜浜1-2-6<br>
                            ＴＥＬ．047-453-7711　 ＦＡＸ．047-453-0670</h3>
                        【営業品目】<br>
                        <h2 id="under10kasen_id">コンピューター・ソフトウェア開発、 ソフトウェア検証、機械設計、電気設計、 デザイン、技術者派遣事業
                        </h2>
                    </div>
                    <div class="">
                ...
                <div id="left">
                    ...
                    <table width="100%" border="0" cellpadding="10" cellspacing="0">
                        <tbody>
                            <tr>
                                <td>
                                    <h2><img src="./image/p_5.gif" alt="" width="27" height="16" align="left"><strong><a style="font-size:1.5rem" href="./index.php">トップページ</a></strong></h2>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p><img src="./image/p_6.gif" alt="" width="41" height="17" align="left"><a href="jigyosyo_yokkaichi.php">四日市事業所</a></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p><img src="./image/p_6.gif" alt="" width="41" height="17" align="left"><a href="recruite_career.php#obo2">応募方法・選考の流れ（キャリア）</a></p>
                                    <p><img src="./image/p_6.gif" alt="" width="41" height="17" align="left"><a href="recruite_kojin.php">エントリー</a></p>
                                    <p><img src="./image/p_6.gif" alt="" width="41" height="17" align="left"><a href="recruite_interview.php">社員インタビュー</a></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h2><img src="./image/p_5.gif" alt="" width="27" height="16" align="left"><strong><a style="font-size:1.5rem" href="https://keisetsu.co.jp/postmail2/postmail.php">お問い合わせ</a></strong></h2>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h2><img src="./image/p_5.gif" alt="" width="27" height="16" align="left"><strong><a style="font-size:1.5rem" href="company.php">会社案内</a></strong></h2>
                                    <p><img src="./image/p_6.gif" alt="" width="41" height="17" align="left"><a href="company.php">ごあいさつ</a></p>
                                    <p><img src="./image/p_6.gif" alt="" width="41" height="17" align="left"><a href="company_gaiyo.php">会社概要・沿革</a></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h2><img src="./image/p_5.gif" alt="" width="27" height="16" align="left"><strong><a style="font-size:1.5rem" href="privacy.php">個人情報保護について</a></strong></h2>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h2><img src="./image/p_5.gif" alt="" width="27" height="16" align="left"><strong><a style="font-size:1.5rem" href="sitemap.php">サイトマップ</a></strong></h2>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div id="footer">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="color:black">
                <tr>
                    <td colspan="2" class="f01"><img src="image/p_footer.gif" alt=""><a href="./index.php">ＨＯＭＥ</a>　<img src="image/p_footer.gif" alt=""><a href="html/prdt_serv.php">製品&amp;サービス</a>　<img src="image/p_footer.gif" alt=""><a href="html/jigyosyo.php">事業所紹介</a>　<img src="image/p_footer.gif" alt="" width="13" height="11"><a href="html/iso.php">ＩＳＯの取り組み</a>　<img src="image/p_footer.gif" alt=""><a href="html/recruite.php">採用情報</a>　<img src="image/p_footer.gif" alt=""><a href="html/company.php">会社案内</a>　<img src="image/p_footer.gif" alt=""><a href="html/sitemap.php">サイトマップ</a>　<img src="image/p_footer.gif" alt=""><a href="https://keisetsu.co.jp/postmail2/postmail.php">お問い合わせ</a></td>
                </tr>
                <tr>
                    <td class="f02"><a href="html/privacy.php">個人情報保護</a></td>
