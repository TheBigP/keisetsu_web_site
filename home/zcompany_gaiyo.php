        ...
        <div id="contents">
            ...
            <div id="right">
                <table width="510" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="under10"><img src="./image/bmida_gaiyo.jpg" alt="会社概要" width="510" height="50"></td>
                    </tr>
                </table>
                <table width="510" border="0" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="hyo"><img src="./image/p_2.gif" alt="" width="9" height="10">本　　　　社</td>
                    ...
                    <tr>
                        <td class="note"><img src="./image/p_2.gif" alt="" width="9" height="10">システム・ソフト<br>
                            　開発事業部
                        </td>
                        <td class="note"> 〒２７５−００２４<br>
                            千葉県習志野市茜浜１−２−６<br>
                            TEL 047-453-0675（代）　FAX 047-453-0670
                        </td>
                    </tr>
                    <tr>
                        <td class="hyo"><img src="./image/p_2.gif" alt="" width="9" height="10">茜浜事業所</td>
                        <td class="hyo"> 〒２７５−００２４<br>
                            千葉県習志野市茜浜１−２−６<br>
                    ...
                    <tr>
                        <td class="note"><img src="./image/p_2.gif" alt="" width="9" height="10">東京事業所</td>
                        <td class="note"> 〒１３６−００７１<br>
                            東京都江東区亀戸６−５７−１４<br>
                            ひまわり江東ビル４Ｆ<br>
                            TEL 03-3637-4101（代）　FAX 03-3637-4102
                        </td>
                    </tr>
                    <tr>
                        <td class="hyo"><img src="./image/p_2.gif" alt="" width="9" height="10">四日市事業所</td>
                ...
                <table width="510" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="right"><a href="company_gaiyo.php"><img src="./image/pagetop.gif" alt="このページの先頭へ"
                                                                           width="60" height="27" border="0"></a></td>
                    </tr>
                </table>
                <br>
                <table width="510" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="under10"><img src="./image/bmida_enkaku.jpg" alt="沿革" width="510" height="50"></td>
                    </tr>
                </table>
                <table width="510" border="0" cellpadding="5" cellspacing="0">
                    <col width="120">
                ...
                <table width="510" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><img src="./image/line_note.gif" alt="" width="510" height="1"></td>
                    </tr>
                    <tr>
                        <td align="right"><a href="company_gaiyo.php"><img src="./image/pagetop.gif" alt="このページの先頭へ"
                                                                           width="60" height="27" border="0"></a></td>
