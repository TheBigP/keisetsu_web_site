            ...
            <div class="col-sm-12">
                <div id="left">
                    ...
                    <table width="100%" class="table table-bordered" border="0" cellpadding="5" cellspacing="0">
                        <tbody>
                            <tr>
                                <td class="top10 fontsize" style="padding: 5px;" width="35%"><img src="./image/flw2_syoruisenko.jpg" alt="書類選考"></td>
                                <td class="top10 fontsize" style="padding: 5px;">お送りいただいた応募データをもとに書類選考をいたします。<br>
                    ...
                    <table width="100%" class="table table-bordered" border="0" cellpadding="5" cellspacing="0">
                        <tbody>
                            <tr>
                                <td class="fontsize" style="padding: 5px;" width="35%"><img src="./image/flw2_naitei.jpg" alt="内定"></td>
                                <td class="fontsize" style="padding: 5px;">応募から内定までは２週間前後を予定しています。<br>
