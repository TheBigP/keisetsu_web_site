...
<head>
    ...
    <title>ソフトウェア開発・機械設計・電気設計・エンジニア派遣・DTPデザインの京設工業株式会社−東京事業所/システムエンジニア/技術者/人材派遣/転職/プラスチック容器</title>
    <!-- InstanceEndEditable -->
            ...
            <div id="contents">
                ...
                <div id="right">
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="under10"><img src="./image/bmida_tokyo.jpg" alt="京設工業 東京事業所" width="510" height="50"></td>
                        </tr>
                    </table>
                    <table width="510" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF">03−3637−4101（代）</td>
                        </tr>
                        <tr>
                            <th bgcolor="#FFFFFF"><img src="./image/p_2.gif" alt="" width="9" height="10">FAX</th>
                            <td bgcolor="#FFFFFF">03−3637−4102</td>
                        </tr>
                        <tr>
                            <th bgcolor="#FFFFFF"><img src="./image/p_2.gif" alt="" width="9" height="10">業務内容</th>
                            <td bgcolor="#FFFFFF">・化粧品、日用品などのプラスチック製品の設計及びDTP</td>
                        </tr>
                    </table>
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img src="./image/minibn_map.gif" alt="京設工業 東京事業所 地図" width="103" height="50"></td>
                        </tr>
                        <tr>
                            <td><img src="./image/map_tokyo.gif" alt="京設工業株式会社東京事業所周辺地図" width="510" height="375"></td>
                        </tr>
                    </table>
                </div>
                <!-- InstanceEndEditable -->
