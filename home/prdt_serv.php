        ...
        <div class="col-sm-12">
            <div id="left">
                <table border="0" cellpadding="0" cellspacing="0">
                    <thead>
                    <tr>
                        <td class="under10"><img src="./image/bmida_sc_kaihatsu.jpg" alt="コンピュータ・ソフトウエア開発部門"
                                                 width="100%"></td>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <tr>
                        <td class="under10" style="font-size:15px"><img src="./image/gz_section2.jpg" alt="デザイン部門"
                                                                        width="140" height="140" align="right">デザイン部門は、プラスチック製品・容器の設計と、パッケージデザイン・校正を行う２部門に分かれ、日々業務を行っています。
                    ...
                    <tr>
                        <td class="under10" style="font-size:15px"><img src="./image/gz_section4.jpg" alt="電気設計部門"
                                                                        width="140" height="140" align="right">電気設計部門は、上水道設備制御設計・制御回路設計を主な業務とし、私たちが毎日使う水を作り出す設備の設計・製図を行っています。環境を配慮し、豊富な経験を活かし、情報をスピーディーに提供することで、お客様に満足していただけるパートナーであり続けるよう、日々努力しています。<br>
                            <br>
