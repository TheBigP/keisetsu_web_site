            ...
            <div class="col-sm-12">
                <div id="left">
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <td class="under10" style="font-size:15px">システム・ソフト開発事業部では、主な業務として、デジタルサイネージで使用されるネットワークプレーヤーやデータプロジェクター、ビデオ会議システム等のファームウェア/制御用アプリケーションソフトウェア開発や検証、産業・流通系現場システムの開発、及び各種民生機器制御用ソフトウェアの開発等を行っています。蓄積された確かな技術と柔軟で豊かな創造性を活かし、多様なニーズに応え続けることにより、お客様から高い信頼を頂いています。<br>
                                    <br>
                            ...
                            <tr>
                                <td class="under10" style="font-size:15px"> <img src="./image/gz_section2.jpg" alt="デザイン部門" width="140" height="140" align="right">デザイン部門は、プラスチック製品・容器の設計と、パッケージデザイン・校正を行う２部門に分かれ、日々業務を行っています。
                                    ...
                                    <br>
                                    <br>
                                    <span class="bluegreen">●</span> プラスチック製品・容器の設計<br> 　　　化粧品・日用品・食品等の製品・容器
                                    <br>
                                    <span class="bluegreen">●</span> 印刷デザイン・ＤＴＰ業務（写植・版下・レタリング）<br> 　　　化粧品・日用品・食品等の製品・容器
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="under10" style="font-size:15px">
                            ...
                            <tr>
                                <td class="under10" style="font-size:15px"> <img src="./image/gz_section4.jpg" alt="電気設計部門" width="140" height="140" align="right">電気設計部門は、上水道設備制御設計・制御回路設計を主な業務とし、私たちが毎日使う水を作り出す設備の設計・製図を行っています。環境を配慮し、豊富な経験を活かし、情報をスピーディーに提供することで、お客様に満足していただけるパートナーであり続けるよう、日々努力しています。<br>
                                    <br>
