...
<head>
    ...
    <title>ソフトウェア開発・機械設計・電気設計・エンジニア派遣・DTPデザインの京設工業株式会社−茜浜事業所/システムエンジニア/技術者/人材派遣/転職/プラスチック容器</title>
    <!-- InstanceEndEditable -->
            ...
            <div id="contents">
                ...
                <div id="right">
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="under10"><img src="./image/bmida_akanehama.jpg" alt="京設工業 茜浜事業所" width="510" height="50"></td>
                        </tr>
                    </table>
                    <table width="510" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF">047−451−8771（代）</td>
                        </tr>
                        <tr>
                            <th bgcolor="#FFFFFF"><img src="./image/p_2.gif" alt="" width="9" height="10">FAX</th>
                            <td bgcolor="#FFFFFF">047−451−8755</td>
                        </tr>
                        <tr>
                            <th bgcolor="#FFFFFF"><img src="./image/p_2.gif" alt="" width="9" height="10">業務内容</th>
                            <td bgcolor="#FFFFFF">・<span class="under10">シーケンス制御の回路設計</span><br>
                                ・<span class="under10">制御盤・操作盤の設計</span></td>
                        </tr>
                    </table>
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img src="./image/minibn_map.gif" alt="京設工業 茜浜事業所 地図" width="103" height="50"></td>
                        </tr>
                        <tr>
                            <td><img src="./image/map_akanehama.gif" alt="京設工業株式会社本社・茜浜事業所周辺地図" width="510" height="375"></td>
                        </tr>
                    </table>
                </div>
                <!-- InstanceEndEditable -->
