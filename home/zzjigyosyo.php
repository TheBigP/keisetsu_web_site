...
<head>
    ...
    <title>ソフトウェア開発・機械設計・電気設計・エンジニア派遣・DTPデザインの京設工業株式会社−本社・システムソフト開発事業部−/システムエンジニア/技術者/人材派遣/転職/プラスチック容器</title>
            ...
            <div id="contents">
                ...
                <div id="right">
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="under10"><img src="./image/bmida_honsya.jpg" alt="京設工業 本社" width="510" height="50"></td>
                        </tr>
                    </table>
                    <table width="510" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF">047−453−7711（代）</td>
                        </tr>
                        <tr>
                            <th bgcolor="#FFFFFF"><img src="./image/p_2.gif" alt="" width="9" height="10">FAX</th>
                            <td bgcolor="#FFFFFF">047−453−0670</td>
                        </tr>
                    </table>
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="top10"><img src="./image/bn_ofic_sistemsoft.jpg" alt="京設工業 システム・ソフト開発事業部" width="510" height="45"></td>
                        </tr>
                    </table>
                    <table width="510" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
                        <col width="70">
                        ...
                        <tr>
                            <th bgcolor="#FFFFFF"><img src="./image/p_2.gif" alt="" width="9" height="10">TEL</th>
                            <td bgcolor="#FFFFFF">047−453−0675</td>
                        </tr>
                        <tr>
                            <th bgcolor="#FFFFFF"><img src="./image/p_2.gif" alt="" width="9" height="10">FAX</th>
                            <td bgcolor="#FFFFFF">047−453−0670</td>
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF">・Windows、UNIXを中心とする各種アプリケーションソフトウェア、システムソフトウェアの受託開発<br>
                                ・インターネット関連各種システムインテグレーション業務<br>
                                ・各種制御装置の組み込みソフトフェアの受託開発</td>
                        </tr>
                    </table>
                    <br>
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img src="./image/minibn_map.gif" alt="京設工業 本社・システム・ソフト開発事業部 地図" width="103" height="50"></td>
                        </tr>
                        <tr>
                            <td><img src="./image/map_honsya.gif" alt="京設工業株式会社本社・茜浜事業所周辺地図" width="510" height="375"></td>
                        </tr>
                    </table>
                </div>
