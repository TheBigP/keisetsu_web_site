            ...
            <div class="page-content inset" data-spy="scroll" data-target="#spy">
                <div class="row">
                    <div class="col-sm-4" style="padding-right:0%;padding-bottom:0%;padding-left:0%">
                        ...
                        <div class="pdserv" style="font-size:15px"><img src="./image/mida_01.gif" alt="製品＆サービス" width="125" height="46">
                    ...
                    <div class="col-sm-4" style="padding-right:0%;padding-left:0%">
                        ...
                        <div class="recruit" style="font-size:15px;"><img src="./image/mida_02.gif" alt="採用情報" width="100" height="46">
                            <table border="0" cellpadding="3" cellspacing="0">
                                <tbody>
                                    <tr>
                    ...
                    <div class="col-sm-4" style="padding-right:0%;padding-left:0%">
                        <img src="./image/line_3contents_right.gif" alt="" width="100%" height="5">
                        <div class="entry" style="font-size:15px"><img src="./image/mida_03.gif" alt="エントリー" width="100" height="46">
                            <table border="0" cellpadding="3" cellspacing="0">
                                <tbody>
                                    <tr>
