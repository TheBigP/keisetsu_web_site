...
<script>
    window.onload = function(){
        ...
        imgs_pdserv.style["width"] = contentLeft_pdserv.offsetWidth - 95 + "px";
        imgs_pdserv.style["height"] = contentLeft_pdserv.offsetWidth - 95 + "px";
        imgs_recruit.style["width"] = contentLeft_recruit.offsetWidth - 95 + "px";
        imgs_recruit.style["height"] = contentLeft_recruit.offsetWidth - 95 + "px";
        imgs_entry.style["width"] = contentLeft_entry.offsetWidth - 95 + "px";
        imgs_entry.style["height"] = contentLeft_entry.offsetWidth - 95 + "px";
        imgs_company.style["width"] = contentLeft_company.offsetWidth - 95 + "px";
        imgs_company.style["height"] = contentLeft_company.offsetWidth - 95 + "px";
