...
<head>
    ...
    <title>ソフトウェア開発/検証・機械設計・電気設計・エンジニア派遣・DTPデザインの京設工業株式会社−個人情報保護について/システムエンジニア/技術者/人材派遣/転職/プラスチック容器</title>
...
<div align="center">
    <div id="frame">
        ...
        <div id="contents">
            ...
            <table width="810" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><img src="./image/im_privacy.jpg" alt="個人情報保護について" width="810" height="100"></td>
                </tr>
            </table>
            ...
            <div id="right">
                <table width="510" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><img src="./image/bn_privacy.jpg" alt="個人情報保護について" width="510" height="50"></td>
                    </tr>
                </table>
                <br>
                    ...
                    <tr>
                        <td>
                            <ol>
                                ...
                                <li> 個人情報の利用目的<br>
                                    弊社は、業務を遂行するうえで必要な個人情報を取得する際に、その利用目的を明らかにして取得し、使用致します。なお、事前にご本人の同意を得ることなく利用目的以外に利用することは致しません。
                                </li>
                                <li> 個人情報の管理<br>
                                    弊社は、個人情報への不当なアクセスまたは個人情報の紛失、破壊、漏洩などの危険に対して、技術面及び組織面において必要な安全対策を継続的に講じるよう努めています。
                                </li>
                                <li>個人情報の第三者への提供<br>
                                    弊社は、法令の定めによる場合を除き、事前にご本人の同意を得ることなく、個人情報を第三者に提供することはありません。
                                </li>
                                <li>個人情報の開示・提供・削除<br>
                                    弊社は、保有している個人情報の開示・訂正・削除をご本人から求められたときは、個人情報の漏洩を防ぐため、ご本人確認が出来た場合に限り開示・訂正・削除をさせて頂きます。
                                </li>
                                <li>個人情報に関するお問い合わせ<br>
                                    京設工業株式会社　個人情報お問合せ窓口<br>
                                    〒275-0024千葉県習志野市茜浜1-2-6<br>
                                    TEL047-453-7711　FAX047-453-0670
                                </li>
                            </ol>
                        </td>
                    </tr>
