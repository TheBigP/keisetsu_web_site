                ...
                <div id="left">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlSelect1"><img src="./image/p_3.gif" alt="" width="15" height="17">お問合せ内容</label>
                        ...
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-2 col-form-label"><img src="./image/p_3.gif" alt="" width="15" height="17">氏　　名</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label for="inputEmail4" class="col-sm-2 col-form-label"><img src="./image/p_3.gif" alt="" width="15" height="17">フリガナ</label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputEmail4" placeholder="姓">
                            <input type="text" class="form-control" id="inputEmail4" placeholder="名"><font color="#FF3300">（全角カタカナ）</font>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail5" class="col-sm-2 col-form-label"><img src="./image/p_3.gif" alt="" width="15" height="17">会社名・学校名</label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputEmail5">
                            </div>
                        </div>
                        <div class="form-group row">
                        <label for="inputEmail6" class="col-sm-2 col-form-label"><img src="./image/p_3.gif" alt="" width="15" height="17">所在地</label>
                            <div  class="col-md-3 mb-3">
                                <label for="validationCustom04">〒</label>
                                <input style='display:inline' id="inputEmail6" class="form-control" type="text"  placeholder="半角数字" > - <input style='display:inline' id="inputEmail6" class="form-control" type="text"  placeholder="半角数字" >
                        ...
                        <div class="form-group row">
                            <label for="inputEmail7" class="col-sm-2 col-form-label"><img src="./image/p_3.gif" alt="" width="15" height="17">電話番号</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="inputEmail7" placeholder="例：03-3333-3333 （半角数字）">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail8" class="col-sm-2 col-form-label"><img src="./image/p_3.gif" alt="" width="15" height="17">メールアドレス</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="inputEmail8" placeholder="（半角数字）">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1"><img src="./image/p_3.gif" alt="" width="15" height="17">お問合せ詳細</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3">出来るだけ詳しくご記入ください。</textarea>
                        </div>
