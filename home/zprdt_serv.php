    ...
    <div id="frame">
        <div id="header">
            ...
            <table width="810" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="270" rowspan="2"><a href="./index.php"><img src="./image/rogo.gif" alt="京設工業株式会社"
                                                                           width="270" height="79" border="0"></a></td>
                    <td width="540" align="right">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><a href="company.php"><img src="./image/m_company.gif" alt="会社案内" width="72"
                                                               height="25" border="0"></a></td>
                                <td><a href="sitemap.php"><img src="./image/m_sitemap.gif" alt="サイトマップ" width="90"
                                                               height="25" border="0"></a></td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td valign="bottom">
                        <ul id="menu">
                            <li><a href="https://keisetsu.co.jp/postmail2/postmail.php"
                                   class="home"><span>京設工業株式会社｜ホーム</span></a></li>
                            <li><a href="recruite.php" class="prdserv"><span>京設工業株式会社｜ソフトウェア開発・機械設計・電気設計・DTPデザイン・エンジニア派遣｜製品とサービス</span></a>
                            </li>
                            ...
                            <li><a href="prdt_serv.php" class="recruit"><span>京設工業株式会社｜エンジニア・技術者・人材派遣｜採用情報</span></a>
                            </li>
        ...
        <div id="contents">
            ...
            <table width="810" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><img src="./image/im_prdt_serv.jpg" alt="製品・サービス" width="810" height="100"></td>
                </tr>
            </table>
            ...
            <div id="right">
                <table width="510" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="under10"><img src="./image/bmida_sc_kaihatsu.jpg" alt="コンピュータ・ソフトウエア開発部門" width="510"
                                                 height="50"></td>
                    </tr>
                    <tr>
                        <td class="under10">
                ...
                <table width="510" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="under10"><img src="./image/bmida_sc_design.jpg" alt="デザイン部門" width="510" height="50">
                        </td>
                    </tr>
                    <tr>
                        <td class="under10"><img src="./image/gz_section2.jpg" alt="デザイン部門" width="140" height="140"
                                                 align="right">デザイン部門は、プラスチック容器の製品設計と、印刷デザイン・文字の校正を日々の業務としています。取り扱う品目は、化粧品、日用品、食品、薬品など、どれも生活に密着したもので、皆様が店頭で見かけたり、実際に使用している身近なものです。毎日の暮らしに欠かせないものを提供させて頂くという立場から、安全性はもちろんのこと、機能性、利便性を追及しながらも、毎日使うものだからこそのこだわりも持ち合わせたいと考えています。それは“心がなごむ”容器。私たちが作る製品を通じて、それを使う方たちの生活が、より心豊かな潤いのあるものとなりますよう、これからもお客様のニーズを大切にしつつ、励んでいきます。<br>
                            <br>
                            <span class="bluegreen">●</span> プラスチック容器製品設計<br>
                            　　　化粧品・洗剤・シャンプー・薬品等の容器<br>
                            <span class="bluegreen">●</span> 印刷デザイン・ＤＴＰ業務（写植・版下・レタリング）<br>
                            　　　化粧品・洗剤・シャンプー・薬品等の容器
                        </td>
                    </tr>
                </table>
                <table width="510" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="under10"><img src="./image/bmida_sc_kikai.jpg" alt="機械設計部門" width="510" height="50">
                        </td>
                    </tr>
                    <tr>
                        <td class="under10">
                            <p>機械設計部門は、経験と確かな実績に培われたベテランと、フレッシュで熱意あふれた若手パワーが団結し、Creo（Pro/E）、iCAD SX、iCAD
                                ...
                                　　　 自動販売機、フード機器、コールドチェーン機器（ショーケース）<br>
                                　　　 駆動制御機器（汎用インバータ、サーボシステム、モータ等）、自動化機器、等</p>
                        </td>
                    </tr>
                </table>
                <table width="510" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="under10"><img src="./image/bmida_sc_denki.jpg" alt="電気設計部門" width="510" height="50">
                        </td>
                    </tr>
                    <tr>
                        <td class="under10"><img src="./image/gz_section4.jpg" alt="電気設計部門" width="140" height="140"
                                                 align="right">電気設計部門は、上水道設備制御設計・制御回路設計を主な業務とし、私たちが毎日使う水を作り出す設備の設計・製図を行っています。環境を配慮し、豊富な経験を活かし、情報をスピーディーに提供することで、お客様に満足していただけるパートナーであり続けるよう、日々努力しています。<br>
                            <br>
                            <span class="bluegreen">●</span> シーケンス制御の回路設計<br>
                            <span class="bluegreen">●</span> 制御盤・操作盤の設計
                        </td>
                    </tr>
                </table>
                <table width="510" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="under10"><img src="./image/bmida_sc_haken.jpg" alt="技術者派遣事業" width="510" height="50">
                        </td>
                    </tr>
                    <tr>
                        <td class="under10">
                            一般労働者派遣事業・有料職業紹介事業の許可を取得し、お取引先の多様なニーズに対応しています。長年蓄積してきた技術力を活かし、技術者派遣という形で即戦力になる人材を、お客様にご提案・ご提供しています。
                            <br>
                            <br>
                            <span class="bluegreen">●</span> 労働者派遣事業許可　派12-090020<br>
                            <span class="bluegreen">●</span> 有料職業紹介事業許可　12-ユ-300062
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <table width="265" border="0" cellpadding="0" cellspacing="0" background="./image/lc_bg_naka.jpg">
                    ...
                    <tr>
                        <td valign="top" class="lc_mado">
                            <h2><strong>京設工業株式会社</strong></h2>
                            <h3>〒275-0024　千葉県習志野市茜浜1-2-6<br>
                                ＴＥＬ 047-453-7711<br>
                                ＦＡＸ 047-453-0670</h3>
                            【営業品目】<br>
                            <h2>コンピューター・ソフトウェア開発、<br>
                                ソフトウェア検証、機械設計、電気設計、<br>
                                デザイン、技術者派遣事業</h2>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><a href="http://www.sankyo-kikai.co.jp/" target="sankyo"><img src="./image/lc_bt_sankyo.jpg"
                                                                                          alt="三京機械工業株式会社" width="265"
                                                                                          height="48" border="0"></a>
                        </td>
                    </tr>
                    <tr>
                        <td><a href="http://erimos.co.jp/" target="erimos"><img src="./image/lc_bt_erimose.jpg"
