            ...
            <div id="contents">
                ...
                <div id="right">
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="under10"><img src="./image/bmida_sc_kaihatsu.jpg" alt="コンピュータ・ソフトウエア開発部門" width="510" height="50"></td>
                        </tr>
                        <tr>
                            <td class="under10"> システム・ソフト開発事業部では、主な業務として、デジタルサイネージで使用されるネットワークプレーヤーやデータプロジェクター、ビデオ会議システム等のファームウェア/制御用アプリケーションソフトウェア開発や検証、産業・流通系現場システムの開発、及び各種民生機器制御用ソフトウェアの開発等を行っています。蓄積された確かな技術と柔軟で豊かな創造性を活かし、多様なニーズに応え続けることにより、お客様から高い信頼を頂いています。<br>
                                <br>
                    ...
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="under10"><img src="./image/bmida_sc_design.jpg" alt="デザイン部門" width="510" height="50"></td>
                        </tr>
                        <tr>
                            <td class="under10"> <img src="./image/gz_section2.jpg" alt="デザイン部門" width="140" height="140" align="right">デザイン部門は、プラスチック容器の製品設計と、印刷デザイン・文字の校正を日々の業務としています。取り扱う品目は、化粧品、日用品、食品、薬品など、どれも生活に密着したもので、皆様が店頭で見かけたり、実際に使用している身近なものです。毎日の暮らしに欠かせないものを提供させて頂くという立場から、安全性はもちろんのこと、機能性、利便性を追及しながらも、毎日使うものだからこそのこだわりも持ち合わせたいと考えています。それは“心がなごむ”容器。私たちが作る製品を通じて、それを使う方たちの生活が、より心豊かな潤いのあるものとなりますよう、これからもお客様のニーズを大切にしつつ、励んでいきます。<br>
                                <br>
                                <span class="bluegreen">●</span> プラスチック容器製品設計<br>
                                　　　化粧品・洗剤・シャンプー・薬品等の容器<br>
                                <span class="bluegreen">●</span> 印刷デザイン・ＤＴＰ業務（写植・版下・レタリング）<br>
                                　　　化粧品・洗剤・シャンプー・薬品等の容器</td>
                        </tr>
                    </table>
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="under10"><img src="./image/bmida_sc_kikai.jpg" alt="機械設計部門" width="510" height="50"></td>
                        </tr>
                        <tr>
                            <td class="under10">
                                <p>機械設計部門は、経験と確かな実績に培われたベテランと、フレッシュで熱意あふれた若手パワーが団結し、Creo（Pro/E）、iCAD SX、iCAD MX等を用いて3D-CAD設計の実践業務を行うとともに、積極的な教育体制を確立し、お客様より高い信頼を頂いています。3D-CAD設計は、多人数のチームで共同設計することにより開発パフォーマンスが上がり、また、試作段階までPC上で行うことができ、人と環境保全に配慮した省エネ・省資源の地球に優しい製品の開発設計を可能にしています。<br>
                                    <br>
                    ...
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="under10"><img src="./image/bmida_sc_denki.jpg" alt="電気設計部門" width="510" height="50"></td>
                        </tr>
                        <tr>
                    ...
                    <table width="510" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="under10"><img src="./image/bmida_sc_haken.jpg" alt="技術者派遣事業" width="510" height="50"></td>
                        </tr>
                        <tr>
                            <td class="under10"> 一般労働者派遣事業・有料職業紹介事業の許可を取得し、お取引先の多様なニーズに対応しています。長年蓄積してきた技術力を活かし、技術者派遣という形で即戦力になる人材を、お客様にご提案・ご提供しています。 <br>
                                <br>
                                <span class="bluegreen">●</span> 労働者派遣事業許可　派12-090020<br>
                                <span class="bluegreen">●</span> 有料職業紹介事業許可　12-ユ-300062</td>
                        </tr>
                    </table>
                </div>
                <!-- InstanceEndEditable -->
